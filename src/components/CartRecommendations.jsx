	...
	return (
		<>
			{data.map((item) => {
				...
				return (
					<div className={`ml-8 h-72 md:h-80 w-60 md:w-72 flex-none rounded-lg shadow-lg transform transition-all hover:-translate-y-3 hover:shadow-xl ${margin}`} id={item.id}>
						<div className="h-3/5">
